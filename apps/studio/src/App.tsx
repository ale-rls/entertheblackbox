  ...
  return <main ref={editorRef} tabIndex={-1} className={`editor${showInspector ? "" : " no-inspector"}${showDiagnostics ? "" : " no-diagnostics"}`} data-sc-tool-density="compact" data-sc-tool-root>
    <header className="menubar">
      ...
      <Menu label="View" items={[
        ...
        { label: "Show settings & groups", onSelect: () => { setSelectedId(undefined); setShowInspector(true); } },
      ...
      <button className="sc-tool-button" data-sc-tool-variant="secondary" type="button" onClick={() => { setSelectedId(undefined); setShowInspector(true); }}>Groups</button>
