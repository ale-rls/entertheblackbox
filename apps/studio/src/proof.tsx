        ...
        <aside className="studio-proof-inspector" aria-labelledby="studio-inspector-title">
          ...
          <div className="studio-proof-inspector-content">
            <div className="sc-tool-field-group">
              ...
              <label className="sc-tool-label">Position layout <span className="sc-tool-mono">field.type + field.variant</span><select className="sc-tool-select" defaultValue="four-quadrant"><option value="four-quadrant">Four quadrants · X + Y axes</option><option value="two-quadrant-x-split">Horizontal vote · hard left / right split</option><option value="two-quadrant-x-spectrum">Horizontal spectrum · left ↔ right</option><option value="two-quadrant-y-split">Vertical vote · hard top / bottom split</option><option value="two-quadrant-y-spectrum">Vertical spectrum · top ↕ bottom</option></select></label>
            </div>
            <div className="sc-tool-field-group">
